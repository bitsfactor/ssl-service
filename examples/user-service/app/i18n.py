...
_MESSAGES: dict[str, dict[str, str]] = {
  ...
  "auth.signup.resend_too_soon":         {"zh-CN": "操作太频繁,请稍后再试", "en-US": "Please wait before requesting another code"},
  "auth.signup.no_pending":              {"zh-CN": "没有待验证的注册,请先填写注册表单", "en-US": "No pending signup — start from the registration form"},
  "auth.signup.code_expired":            {"zh-CN": "验证码已过期,请重新发送", "en-US": "Verification code expired — request a new one"},
  "auth.signup.code_wrong":              {"zh-CN": "验证码不正确",         "en-US": "Incorrect verification code"},
  "auth.signup.too_many_attempts":       {"zh-CN": "尝试次数过多,请重新发送验证码", "en-US": "Too many wrong attempts — request a new code"},
  "auth.signup.otp_email_subject":       {"zh-CN": "Develop.cc 验证码",          "en-US": "Develop.cc verification code"},
  "auth.signup.otp_email_body":          {"zh-CN": "您的 Develop.cc 验证码是: {code}\n\n该验证码 {ttl} 分钟内有效。如果不是您本人操作请忽略此邮件。",
                                          "en-US": "Your Develop.cc verification code is: {code}\n\nIt expires in {ttl} minutes. If you didn't try to sign up, you can ignore this email."},
